...
function Register() {
    ...
    return ( <
        ...
        alt = "" / >
        <
        button onClick = { handleNavigateStudent }
        className = 'bg-[#186BAD] rounded-2xl text-2xl py-3 px-7 text-white font-semibold' >
        <
        span > Sign Up < /span> < /
        button > <
        /div> <
        ...
        <
        img src = { google }
        className = 'border-[1px] rounded-full p-4 border-[#8888] cursor-pointer'
        alt = "" / >
        <
        img src = { facebook }
        className = 'border-[1px] rounded-full p-4 border-[#8888] cursor-pointer'
